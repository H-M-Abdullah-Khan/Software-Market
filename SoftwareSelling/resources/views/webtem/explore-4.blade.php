...
<!-- Mirrored from themesflat.co/html/open9/explore-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:22 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            ...
                                            <li class="menu-item menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item"><a href="explore-4.html">Explore Style 4</a></li>
                ...
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="widget-category-checkbox style-1 mb-30">
                                <h5 class="active">Filter by price</h5>
                                <div class="content-wg-category-checkbox">
                                    <form action="#">
                                        <label>$0 - $100
                                            <input type="checkbox">
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div data-wow-delay="0s" class="wow fadeInUp fl-item-1 col-lg-4 col-md-6">
                                ...
                                <div data-wow-delay="0.1s" class="wow fadeInUp fl-item-1 col-lg-4 col-md-6">
                                    <div class="tf-card-box style-4">
                                        <div class="author flex items-center">
                                            <div class="avatar">
                                                <img src="assets/images/avatar/avatar-box-02.jpg" alt="Image">
                                ...
                                <div data-wow-delay="0.2s" class="wow fadeInUp fl-item-1 col-lg-4 col-md-6">
                                    <div class="tf-card-box style-4">
                                        <div class="author flex items-center">
                                            <div class="avatar">
                                                <img src="assets/images/avatar/avatar-box-02.jpg" alt="Image">
...
<!-- Mirrored from themesflat.co/html/open9/explore-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:23 GMT -->
</html>