...
<!-- Mirrored from themesflat.co/html/open9/slider-animation.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:10 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item has-item">
                                                        ...
                                                        <ul class="nav-sub-menu">
                                                            ...
                                                            <li class="nav-menu-item current-item"><a href="slider-animation.html">Slider Animation</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
                            ...
                            <ul id="menu-mobile-menu" class="menu">
                                <li class="menu-item menu-item-has-children-mobile current-menu-item">
                                    ...
                                    <ul class="sub-menu-mobile">
                                        ...
                                        <li class="menu-item current-item"><a href="slider-animation.html">Slider Animation</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="image-right">
                                <img class="item1" src="assets/images/item-background/slider-animation.png" alt="">
...
<!-- Mirrored from themesflat.co/html/open9/slider-animation.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:12 GMT -->
</html>
