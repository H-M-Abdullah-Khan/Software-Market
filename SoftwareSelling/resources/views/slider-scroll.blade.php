...
<!-- Mirrored from themesflat.co/html/open9/slider-scroll.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:10 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
...
<body class="body">
    ...
    <div id="wrapper">
        <div id="page" class=" pt-40 slider-scroll-page">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item has-item">
                                                        ...
                                                        <ul class="nav-sub-menu">
                                                            ...
                                                            <li class="nav-menu-item current-item"><a href="slider-scroll.html">Slider Scroll</a></li>
                            ...
                            <ul id="menu-mobile-menu" class="menu">
                                <li class="menu-item menu-item-has-children-mobile current-menu-item">
                                    ...
                                    <ul class="sub-menu-mobile">
                                        ...
                                        <li class="menu-item current-item"><a href="slider-scroll.html">Slider Scroll</a></li>
