...
<!-- Mirrored from themesflat.co/html/open9/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:20:47 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            ...
                                            <li class="menu-item menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item"><a href="sign-up.html">Sign up</a></li>
                                                </ul>
                                            </li>
                                            <li class="menu-item menu-item-has-children">
                                                <a>Blog</a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section-1">
                                ...
                                <p class="pb-40">Let’s get started with your 30 days free trial</p>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="widget-login">
                                <form   id="commentform" class="comment-form">
                                    ...
                                    <fieldset class="password">
                                        ...
                                        <input class="password-input" type="password" id="password" placeholder="Confirm password " name="password" tabindex="2" value="" aria-required="true" required>
                                        <i class="icon-show password-addon" id="password-addon"></i>
                                    ...
                                    <div class="btn-submit mb-30">
                                        <a href="login.html" class="tf-button style-1 h50 w-100" type="submit">Sign up<i class="icon-arrow-up-right2"></i></a>
                                    </div>
                                </form>
                                ...
                                <div class="no-account">Already have an account?  <a href="login.html" class="tf-color">Log in</a></div>
                            </div>
                        </div>
                    </div>
                </div>
