...
<!-- Mirrored from themesflat.co/html/open9/nft-detail-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:30 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
        ...
        <div id="page" class="pt-40">
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            ...
                                            <li class="menu-item menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item"><a href="nft-detail-3.html">NFT Detail 3</a></li>
            ...
            <div class="tf-section-2 product-detail">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="infor-product style-1">
                                <div data-wow-delay="0s" class="wow fadeInUp text justify-center">8SIAN Main Collection <span class="icon-tick"><span class="path1"></span><span class="path2"></span></span></div>
                                <h2 data-wow-delay="0s" class="wow fadeInUp text-center pb-30 mb-0">Themesflat #0270</h2>
                                <div class="flex items-center justify-between">
                                    <div data-wow-delay="0s" class="wow fadeInLeft author flex items-center">
                                        <div class="avatar">
                                    ...
                                    <div data-wow-delay="0s" class="wow fadeInUp meta">
                                    ...
                                    <div data-wow-delay="0s" class="wow fadeInRight menu_card position-unset">
                                        <div class="dropdown">
                                            <div class="icon">
                        ...
                        <div class="col-12">
                            <div class="swiper-container carouselfull-2" data-swiper='{
                                "loop":true,
                                "slidesPerView": 1,
                                "observer": true,
                                "observeParents": true,
                        ...
                        <div class="col-12">
                            <div data-wow-delay="0s" class="wow fadeInUp product-item time-sales">
                            ...
                            <div data-wow-delay="0s" class="wow fadeInUp product-item description">
                            ...
                            <div data-wow-delay="0s" class="wow fadeInUp product-item history">
                            ...
                            <div data-wow-delay="0s" class="wow fadeInUp product-item details">
                            ...
                            <div data-wow-delay="0s" class="wow fadeInUp product-item traits style-1">
                            ...
                            <div data-wow-delay="0s" class="wow fadeInUp product-item offers">
                            ...
                            <div data-wow-delay="0s" class="wow fadeInUp product-item item-activity mb-0">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section">
                                <h2 class="tf-title pb-20">Related artworks</h2>
...
<!-- Mirrored from themesflat.co/html/open9/nft-detail-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:39 GMT -->
</html>