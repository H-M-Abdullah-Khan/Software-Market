...
<!-- Mirrored from themesflat.co/html/open9/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:21:47 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            ...
                                            <li class="menu-item menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item"><a href="blog-list.html">Blog List</a></li>
                    ...
                    <div class="row flex flex-wrap">
                        <div class="wrap-inner col-md-8 col-12">
                            <article class="tf-card-article">
                                <div class="card-media mb-20">
                                    <a href="blog-detail.html">
                                        <img src="assets/images/blog/blog-list-01.jpg" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="card-title">
                                    <h5 class="mt-18"><a href="nft-detail-2.html">A revelation about blockchain gaming</a></h5>
                                    <p>For some games, the development process – the dreaming, planning, and talking – is actually the game. I had been wrong to take all the...</p>
                                </div>
                                <div class="card-bottom flex items-center justify-between">
                                    <div class="author flex items-center justify-between">
                                        ...
                                        <div class="info">
                                            <span>Posted by:</span>
                                            <h6><a href="author-2.html">Ronald Richards</a> </h6>
                                        </div>
                                    </div>
                                    <a class="link" href="#"><i class="icon-arrow-up-right2"></i></a>
                                </div>
                            </article>
                            <article class="tf-card-article">
                                <div class="card-media mb-20">
                                    <a href="blog-detail.html">
                                        <img src="assets/images/blog/blog-list-02.jpg" alt="">
                                    </a>
                                </div>
                                <div class="meta-info flex">
                                ...
                                <div class="card-title">
                                    <h5 class="mt-18"><a href="nft-detail-2.html">Star Atlas Showroom 2.1: Massive ships and pretty skins</a></h5>
                                    <p>For some games, the development process – the dreaming, planning, and talking – is actually the game. I had been wrong to take all the...</p>
                                </div>
                                <div class="card-bottom flex items-center justify-between">
                                    <div class="author flex items-center justify-between">
                            ...
                            <article class="tf-card-article">
                                <div class="card-media mb-20">
                                    <a href="blog-detail.html">
                                        <img src="assets/images/blog/blog-list-03.jpg" alt="">
                                    </a>
                                </div>
                                <div class="meta-info flex">
                                    <div class="item art active">Digital Art</div>
                                ...
                                <div class="card-title">
                                    <h5 class="mt-18"><a href="nft-detail-2.html">Vision Pro: Apple’s mixed-reality headset is here</a></h5>
                                    <p>For some games, the development process – the dreaming, planning, and talking – is actually the game. I had been wrong to take all the...</p>
                                </div>
                                <div class="card-bottom flex items-center justify-between">
                                    <div class="author flex items-center justify-between">
                                        ...
                                        <div class="info">
                                            <span>Posted by:</span>
                                            <h6><a href="author-2.html">Savannah Nguyen</a> </h6>
                                        </div>
                                    </div>
                                    <a class="link" href="#"><i class="icon-arrow-up-right2"></i></a>
                                </div>
                            ...
                            <article class="tf-card-article">
                                <div class="card-media mb-20">
                                    <a href="blog-detail.html">
                                        <img src="assets/images/blog/blog-list-04.jpg" alt="">
                                    </a>
                                </div>
                                <div class="meta-info flex">
                                    <div class="item art active">Digital Art</div>
                                ...
                                <div class="card-title">
                                    <h5 class="mt-18"><a href="nft-detail-2.html">New Shrapnel map to mix blossom and blood</a></h5>
                                    <p>For some games, the development process – the dreaming, planning, and talking – is actually the game. I had been wrong to take all the...</p>
                                </div>
                                <div class="card-bottom flex items-center justify-between">
                                    <div class="author flex items-center justify-between">
                                        ...
                                        <div class="info">
                                            <span>Posted by:</span>
                                            <h6><a href="author-2.html">Wade Warren</a> </h6>
                                        </div>
                                    </div>
                                    <a class="link" href="#"><i class="icon-arrow-up-right2"></i></a>
                                </div>
                            ...
                            <article class="tf-card-article">
                                <div class="card-media mb-20">
                                    <a href="blog-detail.html">
                                        <img src="assets/images/blog/blog-list-05.jpg" alt="">
                                    </a>
                                </div>
                                <div class="meta-info flex">
                                    <div class="item art active">Digital Art</div>
                                ...
                                <div class="card-title">
                                    <h5 class="mt-18"><a href="nft-detail-2.html">Meta sticks to guns with lighter, VR focussed Quest 3</a></h5>
                                    <p>For some games, the development process – the dreaming, planning, and talking – is actually the game. I had been wrong to take all the...</p>
                                </div>
                                <div class="card-bottom flex items-center justify-between">
                                    <div class="author flex items-center justify-between">
                                        ...
                                        <div class="info">
                                            <span>Posted by:</span>
                                            <h6><a href="author-2.html">Jenny Wilson</a> </h6>
                                        </div>
                                    </div>
                                    <a class="link" href="#"><i class="icon-arrow-up-right2"></i></a>
                                </div>
...
<!-- Mirrored from themesflat.co/html/open9/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:22:05 GMT -->
</html>