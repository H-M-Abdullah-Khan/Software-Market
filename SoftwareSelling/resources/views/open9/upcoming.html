...
<!-- Mirrored from themesflat.co/html/open9/upcoming.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:42 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
...
<body class="body header-fixed">
    ...
    <div id="wrapper">
        <div id="page" class="pt-40 upcoming-page">
            <!-- header -->
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            ...
                                            <li class="menu-item menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item"><a href="upcoming.html">Upcoming Projects</a></li>
                                                </ul>
                                            </li>
                                            <li class="menu-item menu-item-has-children">
                                                <a>Pages</a>
            ...
            <div class="flat-title-page">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="heading text-center">Upcoming NFT Projects</h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section">
                                <h2 class="tf-title pb-30">May 22</h2>
                            </div>
                        </div>
                                ...
                                <div class="table-ranking-content">
                                    <div data-wow-delay="0s" class="wow fadeInUp fl-row-ranking">
                                        <div class="td1">
                                            ...
                                            <div class="item-avatar">
                                                <img src="assets/images/box-item/upcoming-01.jpg" alt="">
                                            </div>
                                            <div class="item-name">
                                    ...
                                    <div data-wow-delay="0s" class="wow fadeInUp fl-row-ranking">
                                        <div class="td1">
                                            ...
                                            <div class="item-avatar">
                                                <img src="assets/images/box-item/upcoming-03.jpg" alt="">
                                            </div>
                                            <div class="item-name">
                                                On the Edge of Oblivion
                                            </div>
                                    ...
                                    <div data-wow-delay="0s" class="wow fadeInUp fl-row-ranking">
                                        <div class="td1">
                                            ...
                                            <div class="item-avatar">
                                                <img src="assets/images/box-item/upcoming-04.jpg" alt="">
                                            </div>
                                            <div class="item-name">
                                                On the Edge of Oblivion
                                            </div>
...
<!-- Mirrored from themesflat.co/html/open9/upcoming.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:47 GMT -->
</html>