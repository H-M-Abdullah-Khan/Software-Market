...
<!-- Mirrored from themesflat.co/html/open9/home-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:17:43 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
...
<body class="body background-white">
    ...
    <div id="wrapper">
        <div id="page" class="pt-40">
                            ...
                            <div id="site-header-inner"> 
                                <div class="wrap-box flex">
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            <li class="menu-item menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item"><a href="home-5.html">Home 5</a></li>
                                    ...
                                    <div class="flat-wallet flex">
                                        ...
                                        <div class="header-search relative style-1">
                ...
                <div class="themesflat-container w1230">
                    <div class="row">
                        <div class="col-12 pages-title">
                            <div class="content">
                                <h1 data-wow-delay="0s" class="wow fadeInUp">Discover the NFT <br> for worldwid creators</h1>
                                <p data-wow-delay="0.1s" class="wow fadeInUp">Buy and sell NFTs from the world’s top artists</p>
                                <div data-wow-delay="0.2s" class="wow fadeInUp flat-button flex justify-center">
                                    <a href="#" class="tf-button style-1 h50 w140 mr-16">Explore <i class="icon-arrow-up-right2"></i></a>
                                    <a href="#" class="tf-button style-1 h50 w140 active">Create <i class="icon-arrow-up-right2"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="swiper-container swiper-rotate-3" data-swiper='{
                                "loop": true,
                                "spaceBetween": 53,
                                "slidesPerView": 1,
                                "centeredSlides": true,
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-card-box style-2 type-1">
                                            ...
                                            <div class="featured-countdown">
                                                <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"><div aria-hidden="true" class="countdown__timer"><span class="countdown__item" style="display: none;"><span class="countdown__value countdown__value--0 js-countdown__value--0">0</span><span class="countdown__label">d</span></span><span class="countdown__item"><span class="countdown__value countdown__value--1 js-countdown__value--1">02</span><span class="countdown__label">h</span></span><span class="countdown__item"><span class="countdown__value countdown__value--2 js-countdown__value--2">04</span><span class="countdown__label">m</span></span><span class="countdown__item"><span class="countdown__value countdown__value--3 js-countdown__value--3">28</span><span class="countdown__label">s</span></span></div></span>
                                            </div>
            ...
            <div class="tf-section featured-item">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="container-full">
                    <div class="featured pt-10 swiper-container carouselfull-1" data-swiper='{
                        "loop":false,
                        "slidesPerView": 1,
                        "observer": true,
                        "observeParents": true,
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="tf-category style-1 text-center">
                                    <div class="card-media">
                                        <div class="box-top">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section">
                                <h2 class="tf-title pb-30">Our top collection in
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            ...
                                            <div class="author-infor ">
                                                <h5><a href="author-2.html">Theresa Webb</a></h5>
                                                <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
                                            </div>
                                        </div>    	
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tf-author-box text-center">
                                            ...
                                            <div class="author-infor ">
                                                <h5><a href="author-2.html">Devon Lane</a></h5>
                                                <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
                                            </div>
                                        </div>    	
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-card-box style-1 bg-white">
                                            <div class="card-media">
                                                ...
                                                <span class="wishlist-button icon-heart"></span>
                                                <div class="featured-countdown">
                                                    <span class="js-countdown" data-timer="7500" data-labels="d,h,m,s"><div aria-hidden="true" class="countdown__timer"><span class="countdown__item" style="display: none;"><span class="countdown__value countdown__value--0 js-countdown__value--0">0</span><span class="countdown__label">d</span></span><span class="countdown__item"><span class="countdown__value countdown__value--1 js-countdown__value--1">02</span><span class="countdown__label">h</span></span><span class="countdown__item"><span class="countdown__value countdown__value--2 js-countdown__value--2">04</span><span class="countdown__label">m</span></span><span class="countdown__item"><span class="countdown__value countdown__value--3 js-countdown__value--3">10</span><span class="countdown__label">s</span></span></div></span>
                                                </div>
                                            </div>
            ...
            <div class="tf-section-3 seller ">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section pb-30">
                                <h2 class="tf-title ">Top
                                    <span class="dropdown" id="select-day">
                                        <span class="btn-selector tf-color">
                        ...
                        <div data-wow-delay="0s" class="wow fadeInUp col-md-4">
                            <div class="tf-author-box style-2 hv-border mb-30">
                                <div class="order">#1</div>
                                <div class="author-avatar ">
                                    <img src="assets/images/avatar/avatar-08.png" alt="" class="avatar">
                                </div>
                                <div class="author-infor ">
                        ...
                        <div data-wow-delay="0.1s" class="wow fadeInUp col-md-4">
                            <div class="tf-author-box style-2 hv-border mb-30">
                                ...
                                <div class="author-avatar ">
                                    <img src="assets/images/avatar/avatar-09.png" alt="" class="avatar">
                                </div>
                                <div class="author-infor ">
                        ...
                        <div data-wow-delay="0.2s" class="wow fadeInUp col-md-4">
                            <div class="tf-author-box style-2 hv-border mb-30">
                                ...
                                <div class="author-avatar ">
                                    <img src="assets/images/avatar/avatar-10.png" alt="" class="avatar">
                                </div>
                                <div class="author-infor ">
                        ...
                        <div data-wow-delay="0s" class="wow fadeInUp col-md-4">
                            <div class="tf-author-box style-2 hv-border mb-30">
                                ...
                                <div class="author-avatar ">
                                    <img src="assets/images/avatar/avatar-11.png" alt="" class="avatar">
                                </div>
                                <div class="author-infor ">
                                    <h5><a href="author-2.html">Courtney Henry</a></h5>
                                    <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
            ...
            <div class="tf-section-3 discover-item  ">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section pb-30">
                                <h2 class="tf-title ">Trending nFTs</h2>
                                <a href="explore-3.html" class="">Discover more <i class="icon-arrow-right2"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="featured pt-10 swiper-container carousel3" data-swiper='{
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tf-card-collection bg-white">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="action__body bg-white">
                                ...
                                <h2 class="text-center capitalize mx-auto mw-667">Join the world’s largest nFT community &amp; start collecting NFTS</h2>
                                <div class="flat-button flex justify-center">
                                    <a href="#" class="tf-button style-2 h50 w190">Explore now<i class="icon-arrow-up-right2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from themesflat.co/html/open9/home-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:18:15 GMT -->
</html>