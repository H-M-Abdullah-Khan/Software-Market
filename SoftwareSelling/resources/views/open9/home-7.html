...
<!-- Mirrored from themesflat.co/html/open9/home-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:18:39 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="../../assets/icon/Favicon.html">
...
<body class="body counter-scroll sticky-scroll1">
    ...
    <div id="wrapper">
        <div id="page" class="home-7">
                                ...
                                <div class="wrap-box flex">
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            <li class="menu-item menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item"><a href="home-7.html">Home 7</a></li>
                                    ...
                                    <div class="flat-wallet flex">
                                        ...
                                        <div class="widget-search">
                                            <form action="#" method="get" role="search" class="search-form relative">
                                                <input type="search" id="search" class="search-field" placeholder="Search By Keywork..." value="" name="s" title="Search for" required="">
                                                <button class="search search-submit" type="submit" title="Search">
                                                    <i class="icon-search"></i>
                                                </button>
                                            </form>
                        ...
                        <div class="col-12 pages-title">
                            <div class="content">
                                ...
                                <div class="flat-button flex">
                                    <a href="#" class="tf-button style-1 h50 w190 mr-10">Explore more <i class="icon-arrow-up-right2"></i></a>
                                    <a href="#" class="tf-button style-1 h50 w190 active">Wallet connect <i class="icon-wa"></i></a>
                                </div>
                            </div>
                            <div class="icon-background">
                                ...
                                <img class="absolute item5" src="assets/images/item-background/item2.png" alt="">
                            ...
                            <div class="bg-home7">
                                <div class="swiper-container autoslider1reverse" data-swiper='{
                                    "direction": "vertical",
                                    "spaceBetween": 45,
                                    "grabCursor": false,
                                    "speed": 10000,
                            ...
                            <div class="counter__body">
                                <div class="counter">
                                    <div class="number-counter">
                                        <span class="number" data-speed="1000" data-to="15" data-inviewport="yes">15</span>K+
                                    </div>
                                    <h6 class="title">Collections</h6>    
                                </div>
                                <div class="counter">
                                    <div class="number-counter">
                                        <span class="number" data-speed="1000" data-to="217" data-inviewport="yes">217</span>K+
                                    </div>
                                    <h6 class="title">Artworks</h6>    
                                </div>
                                <div class="counter">
                                    <div class="number-counter">
                                        <span class="number" data-speed="1000" data-to="37" data-inviewport="yes">37</span>K+
                                    </div>
                                    <h6 class="title">Artists</h6>    
                                </div>
                            </div>
                            <div class="box-icon-wrap">
                                <div class="tf-box-icon style-1 relative m-0">
                                    <div class="image">
                                ...
                                <div class="tf-box-icon style-1 relative m-0">
                                    ...
                                    <p class="content">Maecenas non semper quam. Vivamus et arcu condimentum ipsum</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section pb-20">
                                <h2 class="tf-title ">Limited auction</h2>
                    ...
                    <div class="featured swiper-container autoslider1" data-swiper='{
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="tf-author-box style-1 text-center flex">
                                    <div class="author-avatar ">
                                        <img src="assets/images/avatar/avatar-small-01.png" alt="" class="avatar">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="tf-author-box style-1 text-center flex">
                                    <div class="author-avatar ">
                                        <img src="assets/images/avatar/avatar-small-02.png" alt="" class="avatar">
                                    </div>
                                    <div class="author-infor ">
                            ...
                            <div class="swiper-slide">
                                <div class="tf-author-box style-1 text-center flex">
                                    <div class="author-avatar ">
                                        <img src="assets/images/avatar/avatar-small-03.png" alt="" class="avatar">
                                    </div>
                                    <div class="author-infor ">
                            ...
                            <div class="swiper-slide">
                                <div class="tf-author-box style-1 text-center flex">
                                    <div class="author-avatar ">
                                        <img src="assets/images/avatar/avatar-small-04.png" alt="" class="avatar">
                                    </div>
                                    <div class="author-infor ">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section pb-30">
                                <h2 class="tf-title ">Browse by category</h2>
                                <a href="explore-3.html" class="">Discover more <i class="icon-arrow-right2"></i></a>
                            </div>
                        </div>
                        <div class="col-md-12">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-category text-center">
                                            <div class="card-media">
                                                ...
                                                <a href="#"><i class="icon-arrow-up-right2"></i></a>
                                            </div>
                                            <h6>Metaverse</h6>
                                        </div>  	
                                    </div>
            ...
            <div class="tf-section-1 seller ">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section">
                                <h2 class="tf-title pb-20">Popular items in last
            ...
            <div class="tf-section seller ">
                <div class="themesflat-container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="swiper-container seller seller-slider" data-swiper='{
                                "loop":false,
                                "slidesPerView": 1,
                                "observer": true,
                                "grabCursor": true,
                                    ...
                                    <div class="swiper-slide">
                                        <div class="grid-author-box">
                                            <div class="tf-author-box style-2 type-1 mb-30">
                                                <div class="author-avatar ">
                                                    <img src="assets/images/avatar/avatar-01.png" alt="" class="avatar">
                                                </div>
                                                <div class="author-infor ">
                                            ...
                                            <div class="tf-author-box style-2 type-1 mb-30">
                                                <div class="author-avatar ">
                                                    <img src="assets/images/avatar/avatar-02.png" alt="" class="avatar">
                                                </div>
                                                <div class="author-infor ">
                                                    <h5><a href="author-2.html">Midjourney NFTs</a></h5>
                                                    <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
                                            ...
                                            <div class="tf-author-box style-2 type-1 mb-30">
                                                <div class="author-avatar ">
                                                    <img src="assets/images/avatar/avatar-03.png" alt="" class="avatar">
                                                </div>
                                                <div class="author-infor ">
                                                    <h5><a href="author-2.html">Midjourney NFTs</a></h5>
                                                    <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
                                            ...
                                            <div class="tf-author-box style-2 type-1 mb-30">
                                                <div class="author-avatar ">
                                                    <img src="assets/images/avatar/avatar-04.png" alt="" class="avatar">
                                                </div>
                                                <div class="author-infor ">
                                                    <h5><a href="author-2.html">Midjourney NFTs</a></h5>
                                                    <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
                                            ...
                                            <div class="tf-author-box style-2 type-1 mb-30">
                                                <div class="author-avatar ">
                                                    <img src="assets/images/avatar/avatar-05.png" alt="" class="avatar">
                                                </div>
                                                <div class="author-infor ">
                                                    <h5><a href="author-2.html">Midjourney NFTs</a></h5>
                                                    <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
                                            ...
                                            <div class="tf-author-box style-2 type-1 mb-30">
                                                <div class="author-avatar ">
                                                    <img src="assets/images/avatar/avatar-06.png" alt="" class="avatar">
                                                </div>
                                                <div class="author-infor ">
                                                    <h5><a href="author-2.html">Midjourney NFTs</a></h5>
                                                    <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
                            ...
                            <div class="swiper-button-next main-next over active"></div>
                            <div class="swiper-button-prev main-prev over "></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tf-section artwork">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section">
                                <h2 class="tf-title pb-30">Find your artwork</h2>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="wrap-checkbox-left po-sticky type1">
                                ...
                                <div class="widget-category-checkbox">
                                    ...
                                    <div class="content-wg-category-checkbox">
                                        <form action="#">
                                            <label><i class="icon-star active"></i><i class="icon-star active"></i><i class="icon-star active"></i><i class="icon-star active"></i><i class="icon-star active"></i>
                                                <input type="radio" name="rating">
                                                <span class="btn-checkbox"></span>
                                            </label><br>
                    
                                            <label><i class="icon-star active"></i><i class="icon-star active"></i><i class="icon-star active"></i><i class="icon-star active"></i><i class="icon-star"></i> &amp; Up
                                                <input type="radio" name="rating">
                                                <span class="btn-checkbox"></span>
                                            </label><br>
                    
                                            <label><i class="icon-star active"></i><i class="icon-star active"></i><i class="icon-star active"></i><i class="icon-star"></i><i class="icon-star"></i> &amp; Up
                                                <input type="radio" name="rating">
                                                <span class="btn-checkbox"></span>
                                            </label><br>
                    
                                            <label><i class="icon-star active"></i><i class="icon-star active"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i> &amp; Up
                                                <input type="radio" name="rating">
                                                <span class="btn-checkbox"></span>
                                            </label><br>
                    
                                            <label><i class="icon-star active"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i> &amp; Up
                                                <input type="radio" name="rating">
                                                <span class="btn-checkbox"></span>
                                            </label><br>
                                        </form>
                        ...
                        <div class="col-md-9">
                            <div class="row po-sticky-footer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="featured pt-10 swiper-container carousel3" data-swiper='{
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tf-card-collection style-2">
                                            <a href="author-2.html">
                                                <div class="media-images-collection">
                                                    <img src="assets/images/box-item/img-collection-t04.jpg" alt="">
                                                    <div class="img-bottom">
                                                        <img src="assets/images/box-item/img-collection-bl04.jpg" alt="">
                                                        <img src="assets/images/box-item/img-collection-bc04.jpg" alt="">
                                                        <img src="assets/images/box-item/img-collection-br04.jpg" alt="">
                                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-card-collection style-2">
                                            <a href="author-2.html">
                                                <div class="media-images-collection">
                                                    <img src="assets/images/box-item/img-collection-t05.jpg" alt="">
                                                    <div class="img-bottom">
                                                        <img src="assets/images/box-item/img-collection-bl05.jpg" alt="">
                                                        <img src="assets/images/box-item/img-collection-bc05.jpg" alt="">
                                                        <img src="assets/images/box-item/img-collection-br05.jpg" alt="">
                                                    </div>
                                                    <div class="author-poster">
                                                        <img src="assets/images/avatar/avatar-01.png" alt="">
                                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-card-collection style-2">
                                            <a href="author-2.html">
                                                <div class="media-images-collection">
                                                    <img src="assets/images/box-item/img-collection-t06.jpg" alt="">
                                                    <div class="img-bottom">
                                                        <img src="assets/images/box-item/img-collection-bl06.jpg" alt="">
                                                        <img src="assets/images/box-item/img-collection-bc06.jpg" alt="">
                                                        <img src="assets/images/box-item/img-collection-br06.jpg" alt="">
                                                    </div>
                                                    <div class="author-poster">
                                                        <img src="assets/images/avatar/avatar-01.png" alt="">
                                                    </div>
...
<!-- Mirrored from themesflat.co/html/open9/home-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:10 GMT -->
</html>
