...
<!-- Mirrored from themesflat.co/html/open9/coming-soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:20:45 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
...
<body class="body header-fixed counter-scroll">
    ...
    <!-- /preload -->
            ...
            <div id="wrapper">
        <div id="page">
            <div class="section-single-page coming-soon">
                <a href="index.html">
