...
<!-- Mirrored from themesflat.co/html/open9/maintenance.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:20:45 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
        ...
        <div id="page">
            ...
            <div class="section-single-page maintanance">
                ...
                <div class="content">
                    ...
                    <div class="status">Website Is Under</div>
                    <h1>Maintenance</h1>
                    <p>We’re sorry our staff is still working on the issue for better experience</p>
                    <div class="box-button">
                        <a href="market.html" class="tf-button style-1 h50 active">My dashboard<i class="icon-arrow-up-right2"></i></a>
                        <a href="index.html" class="tf-button style-1 h50">Back to home<i class="icon-arrow-up-right2"></i></a>
                    </div>
                </div>
