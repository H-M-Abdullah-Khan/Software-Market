...
<!-- Mirrored from themesflat.co/html/open9/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:16:43 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
...
<body class="body">
    ...
    <div id="wrapper">
        <div id="page" class="pt-40">
            ...
            <div class="flat-pages-title-home2 relative">
                <div class="themesflat-container w-full">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="content">
                                <h1 data-wow-delay="0s" class="wow fadeInUp">Create, Explore& Collect Digital Art NFTs</h1>
                                <p data-wow-delay="0.1s" class="wow fadeInUp">Buy and sell NFTs from the world’s top artists. More than 1.000 premium digital artworks are available to be yours!</p>
                                <div data-wow-delay="0.2s" class="wow fadeInUp flat-button flex">
                                    <a href="#" class="tf-button style-1 h50 w190 mr-30">Start Collecting<i class="icon-arrow-up-right2"></i></a>
                                    <a href="#" class="tf-button style-1 h50 w190 active">Create NFT<i class="icon-arrow-up-right2"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="banner__right relative">
                                <div class="swiper-container swiper-3d-3card" data-swiper='{
                                    "loop": false,
                                    "spaceBetween": 0,
                                    "slidesPerView": 1,
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="tf-author-box style-3 text-center">
                                            ...
                                            <div class="author-infor ">
                                                <h5><a href="author-2.html">Jane Cooper</a></h5>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box style-3 text-center">
                                            ...
                                            <div class="author-infor ">
                                                <h5><a href="author-2.html">Darrell Steward</a></h5>
                                                <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
                                            </div>
                                        </div>    	
                                    </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-author-box style-3 text-center">
                                            <div class="author-avatar ">
                                                <img src="assets/images/avatar/avatar-12.png" alt="" class="avatar">
                                                <div class="number">5</div>
                                            </div>
                                            <div class="author-infor ">
                                                <h5><a href="author-2.html">Kathryn Murphy</a></h5>
                                                <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
                                            </div>
                                        </div>    	
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="tf-author-box style-3 text-center">
                                            <div class="author-avatar ">
                                                <img src="assets/images/avatar/avatar-13.png" alt="" class="avatar">
                                                <div class="number">6</div>
                                            </div>
                                            <div class="author-infor ">
                                                <h5><a href="author-2.html">Ralph Edwards</a></h5>
                                                <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95</h6>
                                            </div>
                                        </div>    	
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section pb-20">
                                <h2 class="tf-title ">Live Bidding</h2>
                                <a href="explore-3.html" class="">Discover more <i class="icon-arrow-right2"></i></a>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="featured pt-10 swiper-container carouselfull" data-swiper='{
                                "loop":true,
                                "slidesPerView": 1,
                                "observer": true,
                                "observeParents": true,
                                        ...
                                        <div class="tf-card-box style-1">
                                            ...
                                            <div class="author flex items-center">
                                                ...
                                                <div class="info">
                                                    ...
                                                    <h6><a href="author-2.html">Leslie Alexander</a></h6>
                                                </div>
                                            </div>
                                ...
                                <div class="swiper-button-next next-full"></div>
                                <div class="swiper-button-prev prev-full"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tf-section discover-item loadmore-8-item">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-md-12">
...
<!-- Mirrored from themesflat.co/html/open9/home-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:17:04 GMT -->
</html>