      ...
      <ul class="navbar-nav gap-1 nav-right-links align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
            ...
            <hr class="dropdown-divider">
            <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ url('user-profile')}}"><i
            ...
            <a class="dropdown-item d-flex align-items-center gap-2 py-2" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
    ...
    <div class="sidebar-nav">
        ...
        <ul class="metismenu" id="sidenav">
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/index.html')}}"><i class="material-icons-outlined">arrow_right</i>Analysis</a>
              </li>
              <li><a href="{{url('/../admin/index2.html')}}"><i class="material-icons-outlined">arrow_right</i>eCommerce</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/app-emailbox.html')}}"><i class="material-icons-outlined">arrow_right</i>Email Box</a>
              </li>
              <li><a href="{{url('/../admin/app-emailread.html')}}"><i class="material-icons-outlined">arrow_right</i>Email Read</a>
              </li>
              <li><a href="{{url('/../admin/app-chat-box.html')}}"><i class="material-icons-outlined">arrow_right</i>Chat</a>
              </li>
              <li><a href="{{url('/../admin/app-fullcalender.html')}}"><i class="material-icons-outlined">arrow_right</i>Calendar</a>
              </li>
              <li><a href="{{url('/../admin/app-to-do.html')}}"><i class="material-icons-outlined">arrow_right</i>To do</a>
              </li>
              <li><a href="{{url('/../admin/app-invoice.html')}}"><i class="material-icons-outlined">arrow_right</i>Invoice</a>
              </li>
            </ul>
          </li>
          <li class="menu-label">UI Elements</li>
          <li>
            <a href="{{url('/../admin/cards.html')}}">
          ...
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/ecommerce-add-product.html')}}"><i class="material-icons-outlined">arrow_right</i>Add Product</a>
              </li>
              <li><a href="{{url('/../admin/ecommerce-products.html')}}"><i class="material-icons-outlined">arrow_right</i>Products</a>
              </li>
              <li><a href="{{url('/../admin/ecommerce-customers.html')}}"><i class="material-icons-outlined">arrow_right</i>Customers</a>
              </li>
              <li><a href="{{url('/../admin/ecommerce-customer-details.html')}}"><i class="material-icons-outlined">arrow_right</i>Customer Details</a>
              </li>
              <li><a href="{{url('/../admin/ecommerce-orders.html')}}"><i class="material-icons-outlined">arrow_right</i>Orders</a>
              </li>
              <li><a href="{{url('/../admin/ecommerce-order-details.html')}}"><i class="material-icons-outlined">arrow_right</i>Order Details</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/component-alerts.html')}}"><i class="material-icons-outlined">arrow_right</i>Alerts</a>
              </li>
              <li><a href="{{url('/../admin/component-accordions.html')}}"><i class="material-icons-outlined">arrow_right</i>Accordions</a>
              </li>
              <li><a href="{{url('/../admin/component-badges.html')}}"><i class="material-icons-outlined">arrow_right</i>Badges</a>
              </li>
              <li><a href="{{url('/../admin/component-buttons.html')}}"><i class="material-icons-outlined">arrow_right</i>Buttons</a>
              </li>
              <li><a href="{{url('/../admin/component-carousels.html')}}"><i class="material-icons-outlined">arrow_right</i>Carousels</a>
              </li>
              <li><a href="{{url('/../admin/component-media-object.html')}}"><i class="material-icons-outlined">arrow_right</i>Media
                  Objects</a>
              </li>
              <li><a href="{{url('/../admin/component-modals.html')}}"><i class="material-icons-outlined">arrow_right</i>Modals</a>
              </li>
              <li><a href="{{url('/../admin/component-navs-tabs.html')}}"><i class="material-icons-outlined">arrow_right</i>Navs & Tabs</a>
              </li>
              <li><a href="{{url('/../admin/component-navbar.html')}}"><i class="material-icons-outlined">arrow_right</i>Navbar</a>
              </li>
              <li><a href="{{url('/../admin/component-paginations.html')}}"><i class="material-icons-outlined">arrow_right</i>Pagination</a>
              </li>
              <li><a href="{{url('/../admin/component-popovers-tooltips.html')}}"><i class="material-icons-outlined">arrow_right</i>Popovers
                  & Tooltips</a>
              </li>
              <li><a href="{{url('/../admin/component-progress-bars.html')}}"><i class="material-icons-outlined">arrow_right</i>Progress</a>
              </li>
              <li><a href="{{url('/../admin/component-spinners.html')}}"><i class="material-icons-outlined">arrow_right</i>Spinners</a>
              </li>
              <li><a href="{{url('/../admin/component-notifications.html')}}"><i
                    class="material-icons-outlined">arrow_right</i>Notifications</a>
              </li>
              <li><a href="{{url('/../admin/component-avtars-chips.html')}}"><i class="material-icons-outlined">arrow_right</i>Avatrs &
                  Chips</a>
              </li>
              <li><a href="{{url('/../admin/component-typography.html')}}"><i class="material-icons-outlined">arrow_right</i>Typography</a>
               </li>
               <li><a href="{{url('/../admin/component-text-utilities.html')}}"><i class="material-icons-outlined">arrow_right</i>Utilities</a>
               </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/icons-line-icons.html')}}"><i class="material-icons-outlined">arrow_right</i>Line Icons</a>
              </li>
              <li><a href="{{url('/../admin/icons-boxicons.html')}}"><i class="material-icons-outlined">arrow_right</i>Boxicons</a>
              </li>
              <li><a href="{{url('/../admin/icons-feather-icons.html')}}"><i class="material-icons-outlined">arrow_right</i>Feather
                  Icons</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/form-elements.html')}}"><i class="material-icons-outlined">arrow_right</i>Form Elements</a>
              </li>
              <li><a href="{{url('/../admin/form-input-group.html')}}"><i class="material-icons-outlined">arrow_right</i>Input Groups</a>
              </li>
              <li><a href="{{url('/../admin/form-radios-and-checkboxes.html')}}"><i class="material-icons-outlined">arrow_right</i>Radios &
                  Checkboxes</a>
              </li>
              <li><a href="{{url('/../admin/form-layouts.html')}}"><i class="material-icons-outlined">arrow_right</i>Forms Layouts</a>
              </li>
              <li><a href="{{url('/../admin/form-validations.html')}}"><i class="material-icons-outlined">arrow_right</i>Form Validation</a>
              </li>
              <li><a href="{{url('/../admin/form-wizard.html')}}"><i class="material-icons-outlined">arrow_right</i>Form Wizard</a>
              </li>
              <li><a href="{{url('/../admin/form-file-upload.html')}}"><i class="material-icons-outlined">arrow_right</i>File Upload</a>
              </li>
              <li><a href="{{url('/../admin/form-date-time-pickes.html')}}"><i class="material-icons-outlined">arrow_right</i>Date
                  Pickers</a>
              </li>
              <li><a href="{{url('/../admin/form-select2.html')}}"><i class="material-icons-outlined">arrow_right</i>Select2</a>
              </li>
              <li><a href="{{url('/../admin/form-repeater.html')}}"><i class="material-icons-outlined">arrow_right</i>Form Repeater</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/table-basic-table.html')}}"><i class="material-icons-outlined">arrow_right</i>Basic Table</a>
              </li>
              <li><a href="{{url('/../admin/table-datatable.html')}}"><i class="material-icons-outlined">arrow_right</i>Data Table</a>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li><a class="has-arrow" href="javascript:;"><i class="material-icons-outlined">arrow_right</i>Basic</a>
                <ul>
                  <li><a href="{{url('/../admin/auth-basic-login.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Login</a></li>
                  <li><a href="{{url('/../admin/auth-basic-register.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Register</a></li>
                  <li><a href="{{url('/../admin/auth-basic-forgot-password.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Forgot Password</a></li>
                  <li><a href="{{url('/../admin/auth-basic-reset-password.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Reset Password</a></li>
                </ul>
              </li>
              <li><a class="has-arrow" href="javascript:;"><i class="material-icons-outlined">arrow_right</i>Cover</a>
                <ul>
                  <li><a href="{{url('/../admin/auth-cover-login.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Login</a></li>
                  <li><a href="{{url('/../admin/auth-cover-register.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Register</a></li>
                  <li><a href="{{url('/../admin/auth-cover-forgot-password.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Forgot Password</a></li>
                  <li><a href="{{url('/../admin/auth-cover-reset-password.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Reset Password</a></li>
                </ul>
              </li>
              <li><a class="has-arrow" href="javascript:;"><i class="material-icons-outlined">arrow_right</i>Boxed</a>
                  <ul>
                    <li><a href="{{url('/../admin/auth-boxed-login.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Login</a></li>
                    <li><a href="{{url('/../admin/auth-boxed-register.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Register</a></li>
                    <li><a href="{{url('/../admin/auth-boxed-forgot-password.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Forgot Password</a></li>
                    <li><a href="{{url('/../admin/auth-boxed-reset-password.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>Reset Password</a></li>
                  </ul>
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/pages-error-404.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>404
                  Error</a>
              </li>
              <li><a href="{{url('/../admin/pages-error-505.html')}}" target="_blank"><i class="material-icons-outlined">arrow_right</i>505
                  Error</a>
              </li>
              <li><a href="{{url('/../admin/pages-coming-soon.html')}}" target="_blank"><i
                    class="material-icons-outlined">arrow_right</i>Coming Soon</a>
              </li>
              <li><a href="{{url('/../admin/pages-starter-page.html')}}" target="_blank"><i
                    class="material-icons-outlined">arrow_right</i>Blank Page</a>
              </li>
            </ul>
          </li>
          <li>
            <a href="{{url('/../admin/faq.html')}}">
          ...
          <li>
            <a href="{{url('/../admin/pricing-table.html')}}">
          ...
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/charts-apex-chart.html')}}"><i class="material-icons-outlined">arrow_right</i>Apex</a>
              </li>
              <li><a href="{{url('/../admin/charts-chartjs.html')}}"><i class="material-icons-outlined">arrow_right</i>Chartjs</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/map-google-maps.html')}}"><i class="material-icons-outlined">arrow_right</i>Google Maps</a>
              </li>
              <li><a href="{{url('/../admin/map-vector-maps.html')}}"><i class="material-icons-outlined">arrow_right</i>Vector Maps</a>
              </li>
            </ul>
          </li>
    ...
    <div class="main-content">
      <!--breadcrumb-->
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">{{ __('Admin Dashboard') }}</div>
					<div class="ps-3">
                ...
                <div class="row">
                  <div class="col-12 col-sm-7">
                    <div class="d-flex align-items-center gap-3 mb-5">
                      <img src="{{asset('/../admin/assets/images/avatars/01.png')}}" class="rounded-circle bg-grd-info p-1"  width="60" height="60" alt="user">
                      <div class="">
                  ...
                  <div class="col-12 col-sm-5">
                    <div class="welcome-back-img pt-4">
                       <img src="{{asset('/../admin/assets/images/gallery/welcome-back-3.png')}}" height="180" alt="">
                    </div>
                  </div>
                </div><!--end row-->
              </div>
            ...
            <div class="card w-100 rounded-4">
              ...
              <div class="card-body p-0">
                <div class="user-list p-3">
                  <div class="d-flex flex-column gap-3">
                    <div class="d-flex align-items-center gap-3">
                      <img src="{{asset('/../admin/assets/images/avatars/01.png')}}" width="45" height="45" class="rounded-circle" alt="">
                      <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="{{asset('/../admin/assets/images/avatars/02.png')}}" width="45" height="45" class="rounded-circle" alt="">
                      <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="{{asset('/../admin/assets/images/avatars/03.png')}}" width="45" height="45" class="rounded-circle" alt="">
                      <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="{{asset('/../admin/assets/images/avatars/04.png')}}" width="45" height="45" class="rounded-circle" alt="">
                      <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="{{asset('/../admin/assets/images/avatars/05.png')}}" width="45" height="45" class="rounded-circle" alt="">
                      <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="{{asset('/../admin/assets/images/avatars/06.png')}}" width="45" height="45" class="rounded-circle" alt="">
                      <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center gap-3">
                      <img src="{{asset('/../admin/assets/images/avatars/08.png')}}" width="45" height="45" class="rounded-circle" alt="">
                      <div class="flex-grow-1">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                 <div class="">
                                    <img src="{{asset('/../admin/assets/images/top-products/01.png')}}" class="rounded-circle" width="50" height="50" alt="">
                                 </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                 <div class="">
                                    <img src="{{asset('/../admin/assets/images/top-products/02.png')}}" class="rounded-circle" width="50" height="50" alt="">
                                 </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                 <div class="">
                                    <img src="{{asset('/../admin/assets/images/top-products/03.png')}}" class="rounded-circle" width="50" height="50" alt="">
                                 </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                 <div class="">
                                    <img src="{{asset('/../admin/assets/images/top-products/04.png')}}" class="rounded-circle" width="50" height="50" alt="">
                                 </div>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center gap-3">
                                 <div class="">
                                    <img src="{{asset('/../admin/assets/images/top-products/06.png')}}" class="rounded-circle" width="50" height="50" alt="">
                                 </div>
