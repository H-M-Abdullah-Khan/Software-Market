...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Mar 2025 14:22:37 GMT -->
...
<body>
        ...
        <div class="main-content">
            ...
            <div class="row g-3">
                <div class="col-auto d-flex">
                    <form method="GET" action="{{ route('products.Search1') }}"
                        class="search-form d-flex w-100 align-items-center">
                        <div class="position-relative d-flex w-100">
                            <input class="form-control px-4" type="search" name="search"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="product-info">
                                                        <h5 class="name">
                                                            <a style="color: white; text-transform: capitalize; text-decoration: none;"
                                                                href="{{ route('software_products.show', $product->id) }}">
    ...
    <input type="number" step="0.01" name="price" placeholder="Price (only if paid)">
    <input type="file" name="main_file" required>
    <input type="file" name="screenshots[]" multiple>
    <input type="url" name="demo_url" placeholder="Demo URL">
