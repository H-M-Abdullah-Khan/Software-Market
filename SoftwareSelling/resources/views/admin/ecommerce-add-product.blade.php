    ...
    <main class="main-wrapper">
        ...
        <div class="container">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('software-products.store') }}" method="POST"
                ...
                <div class="card-body">
                    @foreach ($products as $product)
                        <div class="border p-3 mb-3">
                            <h5>{{ $product->name }} <small
                                    class="text-muted">({{ $product->pricing_type }})</small></h5>
                            <p>{{ $product->description }}</p>
                            <p><strong>Category:</strong> {{ $product->category }} | <strong>Price:</strong>
                                ${{ $product->price ?? '0.00' }}</p>
                            @if ($product->demo_url)
                                <p><a href="{{ $product->demo_url }}" target="_blank">View Demo</a></p>
                            @endif
