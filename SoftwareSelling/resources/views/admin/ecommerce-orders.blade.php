            ...
            <div class="customer-table">
              <div class="table-responsive white-space-nowrap">
                <table class="table align-middle">
                   <h1 class="text-center mb-3">Purchase Requests</h1>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($request->status == 'pending')
                                <form action="{{ route('orders.approve', $request->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    <button type="submit">Approve</button>
                                </form>
                                <form action="{{ route('orders.reject', $request->id) }}" method="POST" style="display:inline;">
                                    @csrf
                       ...
                       <td>
                        <a class="d-flex align-items-center gap-3" href="javascript:;">
                          <div class="customer-pic">
                            <img src="{{ url('/../admin/assets/images/avatars/01.png') }}" class="rounded-circle" width="40" height="40" alt="">
                          </div>
