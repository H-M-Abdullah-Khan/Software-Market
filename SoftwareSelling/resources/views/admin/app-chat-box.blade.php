...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/app-chat-box by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Mar 2025 14:22:19 GMT -->
<head>
  <meta charset="utf-8">
      ...
      <div class="chat-wrapper">
                ...
                <div class="chat-list">
                  <div class="list-group list-group-flush">
                    <a href="javascript:;" class="list-group-item">
                      <div class="d-flex">
                        <div class="chat-user-online">
                          <img src="{{asset('/../admin/assets/images/avatars/02.png')}}" width="42" height="42" class="rounded-circle" alt="" />
                        </div>
                        <div class="flex-grow-1 ms-2">
                    ...
                    <a href="javascript:;" class="list-group-item active">
                      <div class="d-flex">
                        <div class="chat-user-online">
                          <img src="{{asset('/../admin/assets/images/avatars/03.png')}}" width="42" height="42" class="rounded-circle" alt="" />
                        </div>
                        <div class="flex-grow-1 ms-2">
                    ...
                    <a href="javascript:;" class="list-group-item">
                      <div class="d-flex">
                        <div class="chat-user-online">
                          <img src="{{asset('/../admin/assets/images/avatars/04.png')}}" width="42" height="42" class="rounded-circle" alt="" />
                        </div>
                        <div class="flex-grow-1 ms-2">
                    ...
                    <a href="javascript:;" class="list-group-item">
                      <div class="d-flex">
                        <div class="chat-user-online">
                          <img src="{{asset('/../admin/assets/images/avatars/05.png')}}" width="42" height="42" class="rounded-circle" alt="" />
                        </div>
                        <div class="flex-grow-1 ms-2">
                    ...
                    <a href="javascript:;" class="list-group-item">
                      <div class="d-flex">
                        <div class="chat-user-online">
                          <img src="{{asset('/../admin/assets/images/avatars/06.png')}}" width="42" height="42" class="rounded-circle" alt="" />
                        </div>
                        <div class="flex-grow-1 ms-2">
                    ...
                    <a href="javascript:;" class="list-group-item">
                      <div class="d-flex">
                        <div class="chat-user-online">
                          <img src="{{asset('/../admin/assets/images/avatars/07.png')}}" width="42" height="42" class="rounded-circle" alt="" />
                        </div>
                        <div class="flex-grow-1 ms-2">
                    ...
                    <a href="javascript:;" class="list-group-item">
                      <div class="d-flex">
                        <div class="chat-user-online">
                          <img src="{{asset('/../admin/assets/images/avatars/09.png')}}" width="42" height="42" class="rounded-circle" alt="" />
                        </div>
                        <div class="flex-grow-1 ms-2">
                    ...
                    <a href="javascript:;" class="list-group-item">
                      <div class="d-flex">
                        <div class="chat-user-online">
                          <img src="{{asset('/../admin/assets/images/avatars/10.png')}}" width="42" height="42" class="rounded-circle" alt="" />
                        </div>
                        <div class="flex-grow-1 ms-2">
                    ...
                    <a href="javascript:;" class="list-group-item">
                      <div class="d-flex">
                        <div class="chat-user-online">
                          <img src="{{asset('/../admin/assets/images/avatars/11.png')}}" width="42" height="42" class="rounded-circle" alt="" />
                        </div>
                        <div class="flex-grow-1 ms-2">
        ...
        <div class="chat-content">
          <div class="chat-content-leftside">
            <div class="d-flex">
              <img src="{{asset('/../admin/assets/images/avatars/03.png')}}" width="48" height="48" class="rounded-circle" alt="" />
              <div class="flex-grow-1 ms-2">
...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/app-chat-box')}} by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Mar 2025 14:22:20 GMT -->
</html>