...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/form-layouts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Mar 2025 14:23:03 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <div class="sidebar-nav">
        ...
        <ul class="metismenu" id="sidenav">
          <li>
            ...
            <ul>
              <li><a href="{{url('/../admin/index')}}"><i class="material-icons-outlined">arrow_right</i>Analysis</a>
              </li>
              <li><a href="{{url('/../admin/index2')}}"><i class="material-icons-outlined">arrow_right</i>eCommerce</a>
              </li>
            </ul>
          </li>
          <li>
