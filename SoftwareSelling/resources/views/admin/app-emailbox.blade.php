...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/app-emailbox by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Mar 2025 14:22:18 GMT -->
<head>
  <meta charset="utf-8">
        ...
        <div class="email-sidebar-content">
          <div class="email-navigation">
            <div class="list-group list-group-flush"> 
              <a href="{{ url ('admin/app-emailbox')}}')}}" class="list-group-item active d-flex align-items-center"><i class='bx bxs-inbox me-3 font-20'></i><span>Inbox</span><span class="badge bg-primary rounded-pill ms-auto">7,513</span></a>
              ...
              <div class="list-group-item email-hangout cursor-pointer border-top">
                <div class="d-flex align-items-center gap-3">
                  <div class="chat-user-online">
                    <img src="{{asset('/../admin/assets/images/avatars/01.png')}} width="42" height="42" class="rounded-circle" alt="">
                  </div>
      ...
      <div class="email-content">
        <div class="">
          <div class="email-list">
            <a href="{{ url ('admin/app-emailread')}}">
...
<!-- Mirrored from codervent.com/maxton/demo/vertical-menu/app-emailbox by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Mar 2025 14:22:19 GMT -->
</html>