...
<!-- Mirrored from themesflat.co/html/open9/{{url ('author-2') }}"> by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:20:44 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
...
')}}" >
                ...
                <div class="mobile-nav-wrap">
                    ...
                    <div class="inner-mobile-nav">
                        <a href="{{ url('welcome') }}" rel="home" class="main-logo">
                            <img id="mobile-logo_header" src="{{asset('../template/assets/images/logo/logo.png')}}
...
">
            ...
            <div class="tf-section-2">
                <div class="themesflat-container">
                    <div class="row">
                        <div data-wow-delay="0s" class="wow fadeInUp col-xl-2 col-sm-3 col-6 mb-30">
                            <div class="tf-author-box style-3 text-center">
                                <div class="author-avatar ">
                                    <img src="{{asset('/../template/assets/images/avatar/avatar-08.png')}}
')}}" alt="" class="avatar">
                        ...
                        <div data-wow-delay="0.1s" class="wow fadeInUp col-xl-2 col-sm-3 col-6 mb-30">
                            <div class="tf-author-box style-3 text-center">
                                <div class="author-avatar ">
                                    <img src="{{asset('/../template/assets/images/avatar/avatar-09.png')}}
')}}" alt="" class="avatar">
                        ...
                        <div data-wow-delay="0.2s" class="wow fadeInUp col-xl-2 col-sm-3 col-6 mb-30">
                            <div class="tf-author-box style-3 text-center">
                                <div class="author-avatar ">
                                    <img src="{{asset('/../template/assets/images/avatar/avatar-10.png')}}
')}}" alt="" class="avatar">
                        ...
                        <div data-wow-delay="0.3s" class="wow fadeInUp col-xl-2 col-sm-3 col-6 mb-30">
                            <div class="tf-author-box style-3 text-center">
                                <div class="author-avatar ">
                                    <img src="{{asset('/../template/assets/images/avatar/avatar-11.png')}}
')}}" alt="" class="avatar">
                        ...
                        <div data-wow-delay="0.4s" class="wow fadeInUp col-xl-2 col-sm-3 col-6 mb-30">
                            <div class="tf-author-box style-3 text-center">
                                <div class="author-avatar ">
                                    <img src="{{asset('/../template/assets/images/avatar/avatar-12.png')}}
')}}" alt="" class="avatar">
                        ...
                        <div data-wow-delay="0.5s" class="wow fadeInUp col-xl-2 col-sm-3 col-6 mb-30">
                            <div class="tf-author-box style-3 text-center">
                                <div class="author-avatar ">
                                    <img src="{{asset('/../template/assets/images/avatar/avatar-13.png')}}
')}}" alt="" class="avatar">
...
')}}" alt="" class="avatar">
                        ...
                        <div class="col-12">
                            <div class="widget-pagination pt-25">
...
<!-- Mirrored from themesflat.co/html/open9/"> by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:20:44 GMT -->
</html>