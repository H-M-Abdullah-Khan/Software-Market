...
<!-- Mirrored from themesflat.co/html/open9/ranking.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:39 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
        ...
        <div id="page" class="pt-40">
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            ...
                                            <li class="menu-item menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item"><a href="ranking.html">Ranking</a></li>
            ...
            <div class="flat-title-page">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="heading text-center">Rankings</h1>
                            ...
                            <div class="widget-tabs relative">
                                ...
                                <ul class="widget-menu-tab">
                                    <li class="item-title active">
                                        <span class="inner">All Category</span>
                                    </li>
                                    <li class="item-title">
                                        <span class="inner">All Category</span>
                                    </li>
                                ...
                                <div class="widget-content-tab pt-10">
                                    ...
                                    <div class="widget-content-inner">
                                        <div class="widget-table-ranking">
                                            <div class="table-ranking-heading">
                                                <div class="column1">
                                                    <h3>Collection</h3>
                                                </div>
                                                <div class="column2">
...
<!-- Mirrored from themesflat.co/html/open9/ranking.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:19:42 GMT -->
</html>