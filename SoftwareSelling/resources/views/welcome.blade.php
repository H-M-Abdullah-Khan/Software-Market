            ...
            <div id="page" class="pt-40 home-1">
                                            ...
                                            <ul id="menu-primary-menu" class="menu">
                                                ...
                                                <li class="menu-item menu-item-has-children">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="nav-menu-item"><a
                                                                href="{{ url('market') }}">Market</a></li>
                                                        <li class="nav-menu-item"><a
                                                                href="{{ url('market-active-bid') }}">Active Bid</a>
                                                        </li>
                                                        <li class="nav-menu-item"><a
                                                        ...
                                                        <li class="nav-menu-item"><a
                                                                href="{{ url('market-favorite') }}">My favorite</a>
                                                        </li>
                                                        <li class="nav-menu-item"><a
                                ...
                                <ul id="menu-mobile-menu" class="menu">
                                    ...
                                    <li class="menu-item menu-item-has-children-mobile">
                                        ...
                                        <ul class="sub-menu-mobile">
                                            ...
                                            <li class="menu-item"><a href="{{ url('market-create') }}">Create</a>
                                            </li>
                                            <li class="menu-item"><a href="{{ url('market-active-bid') }}">Active
                                                    Bid</a></li>
                                            <li class="menu-item"><a href="{{ url('market-explore') }}">Explore</a>
                                            </li>
                                            <li class="menu-item"><a href="{{ url('market-collection') }}">My
                                                    collection</a></li>
                                            <li class="menu-item"><a href="{{ url('market-favorite') }}">My
                                                    favorite</a></li>
                                            <li class="menu-item"><a href="{{ url('market-wallet') }}">Wallet</a>
                                            </li>
                                            <li class="menu-item"><a href="{{ url('market-history') }}">History</a>
                                            </li>
                        ...
                        <div class="row">
                            <div class="col-12 pages-title">
                                <div class="content">
                                    ...
                                    <p class="wow fadeInUp" data-wow-delay="0.1s">Welcome to the world of rare digital
                                        art. Explore the best art from hand-picked digital artist out there and find the
                                        hidden gem.</p>
                                    <div data-wow-delay="0.2s" class=" wow fadeInUp flat-button flex justify-center">
                                        <a href="#" class="tf-button style-1 h50 w190 mr-16">Discover more <i
                                                class="icon-arrow-up-right2"></i></a>
                                        <a href="#" class="tf-button style-1 h50 w190 active">All collections <i
                                                class="icon-arrow-up-right2"></i></a>
                                    </div>
                                </div>
                                <div class="icon-background">
                                    <img class="absolute item1"
                                        src="{{ asset('/../template/assets/images/item-background/item1.png') }}"
                                        alt="">
                                    <img class="absolute item2"
                                        src="{{ asset('/../template/assets/images/item-background/item2.png') }}"
                                        alt="">
                                    <img class="absolute item3"
                                        src="{{ asset('/../template/assets/images/item-background/item3.png') }}"
                                        alt="">
                                    ...
                                    <img class="absolute item5"
                                        src="{{ asset('/../template/assets/images/item-background/item1.png') }}"
                                        alt="">
                                    <img class="absolute item6"
                                        src="{{ asset('/../template/assets/images/item-background/item4.png') }}"
                                        alt="">
                                    <img class="absolute item7"
                                        src="{{ asset('/../template/assets/images/item-background/item5.png') }}"
                                        alt="">
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="tf-card-box">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('/../template/assets/images/box-item/banner-01.jpg') }}"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                                            <span class="js-countdown" data-timer="7500"
                                                                data-labels="d,h,m,s"></span>
                                                        </div>
                                                        <div class="button-place-bid">
                                                            <a href="#" data-toggle="modal"
                                                                data-target="#popup_bid" class="tf-button"><span>Place
                                                                    Bid</span></a>
                                                        </div>
                                                    </div>
                                                    <div class="meta-info text-center">
                                                        <h5 class="name"><a href="{{ url('nft-detail-2') }}">Dayco
                                                                serpentine belt</a></h5>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tf-card-box">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('/../template/assets/images/box-item/banner-02.jpg') }}"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tf-card-box">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('/../template/assets/images/box-item/banner-03.jpg') }}"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tf-card-box">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('/../template/assets/images/box-item/banner-04.jpg') }}"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tf-card-box">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('/../template/assets/images/box-item/banner-05.jpg') }}"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tf-card-box">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('/../template/assets/images/box-item/banner-06.jpg') }}"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tf-card-box">
                                                    <div class="card-media">
                                                        <a href="#">
                                                            <img src="{{ asset('/../template/assets/images/box-item/banner-07.jpg') }}"
                                                                alt="">
                                                        </a>
                                                        <span class="wishlist-button icon-heart"></span>
                                                        <div class="featured-countdown">
                                ...
                                "breakpoints": {
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="tf-author-box text-center">
                                                <div class="author-avatar ">
                                                    <img src="{{ asset('/../template/assets/images/avatar/avatar-01.png') }}"
                                                        alt="" class="avatar">
                                                    <div class="number">1</div>
                                                </div>
                                                <div class="author-infor ">
                                                    <h5><a href="{{ url('author-2') }}">Courtney Henry</a></h5>
                                                    <h6 class="price gem style-1"><i class="icon-gem"></i>7,080.95
                                                    </h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="tf-author-box text-center">
                                                <div class="author-avatar ">
                                                    <img src="{{ asset('/../template/assets/images/avatar/avatar-02.png') }}"
                                                        alt="" class="avatar">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-author-box text-center">
                                                <div class="author-avatar ">
                                                    <img src="{{ asset('/../template/assets/images/avatar/avatar-03.png') }}"
                                                        alt="" class="avatar">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-author-box text-center">
                                                <div class="author-avatar ">
                                                    <img src="{{ asset('/../template/assets/images/avatar/avatar-04.png') }}"
                                                        alt="" class="avatar">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-author-box text-center">
                                                <div class="author-avatar ">
                                                    <img src="{{ asset('/../template/assets/images/avatar/avatar-05.png') }}"
                                                        alt="" class="avatar">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-author-box text-center">
                                                <div class="author-avatar ">
                                                    <img src="{{ asset('/../template/assets/images/avatar/avatar-06.png') }}"
                                                        alt="" class="avatar">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="heading-section pb-30">
                                    ...
                                    <a href="explore-3') }}" class="">Discover more <i
                            ...
                            <div data-wow-delay="0s" class="wow fadeInUp col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="tf-card-box style-1">
                                    <div class="card-media">
                                        <a href="#">
                                            <img src="{{ asset('/../template/assets/images/box-item/card-item-05.jpg') }}"
                                                alt="">
                                        </a>
                                        <span class="wishlist-button icon-heart"></span>
                                        <div class="featured-countdown">
                                    ...
                                    <h5 class="name"><a href="{{ url('nft-detail-2') }}">Dayco serpentine
                                            belt</a></h5>
                                    <div class="author flex items-center">
                                        <div class="avatar">
                                            <img src="{{ asset('/../template/assets/images/avatar/avatar-box-01.jpg') }}"
                            ...
                            <div data-wow-delay="0.1s" class="wow fadeInUp col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="tf-card-box style-1">
                                    <div class="card-media">
                                        <a href="#">
                                            <img src="{{ asset('/../template/assets/images/box-item/card-item-06.jpg') }}"
                                                alt="">
                                        </a>
                                        <span class="wishlist-button icon-heart"></span>
                                        <div class="featured-countdown">
                            ...
                            <div data-wow-delay="0.2s" class="wow fadeInUp col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="tf-card-box style-1">
                                    <div class="card-media">
                                        <a href="#">
                                            <img src="{{ asset('/../template/assets/images/box-item/card-item-07.jpg') }}"
                                                alt="">
                                        </a>
                                        <span class="wishlist-button icon-heart"></span>
                                        <div class="featured-countdown">
                            ...
                            <div data-wow-delay="0.3s" class="wow fadeInUp col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div class="tf-card-box style-1">
                                    <div class="card-media">
                                        <a href="#">
                                            <img src="{{ asset('/../template/assets/images/box-item/card-item-08.jpg') }}"
                                                alt="">
                                        </a>
                                        <span class="wishlist-button icon-heart"></span>
                                        <div class="featured-countdown">
                ...
                <div class="tf-section top-collector">
                    <div class="top-collector-wrapper">
                        ...
                        <div class="featured swiper-container autoslider1"
                            data-swiper='{
                        "loop": false,
                        "spaceBetween": 28,
                        "slidesPerView": "auto",
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="tf-author-box style-1 text-center flex">
                                        <div class="author-avatar ">
                                            <img src="{{ asset('/../template/assets/images/avatar/avatar-small-01.png') }}"
                                                alt="" class="avatar">
                                        </div>
                                        <div class="author-infor ">
                                ...
                                <div class="swiper-slide">
                                    <div class="tf-author-box style-1 text-center flex">
                                        <div class="author-avatar ">
                                            <img src="{{ asset('/../template/assets/images/avatar/avatar-small-02.png') }}"
                                                alt="" class="avatar">
                                        </div>
                                        <div class="author-infor ">
                                ...
                                <div class="swiper-slide">
                                    <div class="tf-author-box style-1 text-center flex">
                                        <div class="author-avatar ">
                                            <img src="{{ asset('/../template/assets/images/avatar/avatar-small-03.png') }}"
                                                alt="" class="avatar">
                                        </div>
                                        <div class="author-infor ">
                                ...
                                <div class="swiper-slide">
                                    <div class="tf-author-box style-1 text-center flex">
                                        <div class="author-avatar ">
                                            <img src="{{ asset('/../template/assets/images/avatar/avatar-small-04.png') }}"
                                                alt="" class="avatar">
                                        </div>
                                        <div class="author-infor ">
                        ...
                        <div class="featured mt-17 swiper-container autoslider2"
                            data-swiper='{
                        "loop": false,
                        "spaceBetween": 28,
                        "slidesPerView": "auto",
                ...
                <div class="tf-section top-collections">
                    <div class="themesflat-container">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="featured pt-10 swiper-container carousel3"
                                    data-swiper='{
                                "loop":false,
                                "slidesPerView": 1,
                                "spaceBetween": 30,
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="tf-card-collection">
                                                <a href="{{ url('author-2') }}">
                                                    <div class="media-images-collection">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-01.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-02.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-03.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-04.jpg') }}"
                                                            alt="">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-collection">
                                                <a href="{{ url('author-2') }}">
                                                    <div class="media-images-collection">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-05.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-06.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-07.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-08.jpg') }}"
                                                            alt="">
                                                        <div class="author-poster">
                                                            <img src="{{ asset('/../template/assets/images/avatar/avatar-01.png') }}"
                                                                alt="" class="w-full">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-collection">
                                                <a href="{{ url('author-2') }}">
                                                    <div class="media-images-collection">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-09.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-10.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-11.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-12.jpg') }}"
                                                            alt="">
                                                        <div class="author-poster">
                                                            <img src="{{ asset('/../template/assets/images/avatar/avatar-02.png') }}"
                                                                alt="" class="w-full">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="tf-card-collection">
                                                <a href="{{ url('author-2') }}">
                                                    <div class="media-images-collection">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-13.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-14.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-15.jpg') }}"
                                                            alt="">
                                                        <img src="{{ asset('/../template/assets/images/box-item/img-collection-16.jpg') }}"
                                                            alt="">
                                                        <div class="author-poster">
                                                            <img src="{{ asset('/../template/assets/images/avatar/avatar-03.png') }}"
                                                                alt="" class="w-full">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="tf-box-icon relative text-center">
                                    <div class="image">
                                        <img src="{{ asset('/../template/assets/images/box-icon/icon-01.png') }}"
                                            alt="">
                                        <p>Step 1</p>
                                    </div>
                                    <h4 class="heading"><a href="{{ url('contact-us') }}">Set Up Your Wallet</a>
                                    </h4>
                                    <p class="content">Fusce non dignissim velit, sit amet semper eros. Quisque orci
                                        est</p>
                                    <div class="arrow">
                                        <svg width="114" height="114" viewBox="0 0 114 114" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_625_20131)">
                                                ...
                                                <circle cx="8.69433" cy="59.7296" r="3.91825"
                                                    transform="rotate(-135 8.69433 59.7296)" stroke="#919191"
                                                    stroke-width="2" />
                                            </g>
                                            <defs>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="tf-box-icon relative text-center type-1">
                                    <div class="image">
                                        <img src="{{ asset('/../template/assets/images/box-icon/icon-02.png') }}"
                                            alt="">
                                        <p>Step 2</p>
                                    </div>
                                    <h4 class="heading"><a href="{{ url('contact-us') }}">Create your
                                            collection</a></h4>
                                    <p class="content">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                        Pellentesque luctus</p>
                                    <div class="arrow">
                                        <svg width="114" height="114" viewBox="0 0 114 114" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_625_20131)">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="tf-box-icon relative text-center">
                                    <div class="image">
                                        <img src="{{ asset('/../template/assets/images/box-icon/icon-03.png') }}"
                                            alt="">
                                        <p>Step 3</p>
                                    </div>
                                    <h4 class="heading"><a href="{{ url('contact-us') }}">Add your NFTs</a></h4>
                                    <p class="content">Suspendisse porttitor id est non accumsan. Cras vel viverra
                                        velit</p>
                                    <div class="arrow">
                                        <svg width="114" height="114" viewBox="0 0 114 114" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="tf-box-icon relative text-center">
                                    <div class="image">
                                        <img src="{{ asset('/../template/assets/images/box-icon/icon-04.png') }}"
                                            alt="">
                                        <p>Step 4</p>
                                    </div>
                                    <h4 class="heading"><a href="{{ url('contact-us') }}">Sell your NFTs</a></h4>
                                    <p class="content">Maecenas non semper quam. Vivamus et arcu condimentum ipsum
                                        consectetur</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="action__body">
                                    ...
                                    <div class="bg-home7">
                                        ...
                                        "autoplay": {
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <img src="{{ asset('/../template/assets/images/item-background/bg-action-1.png') }}"
                                                        alt="">
                                                </div>
                                                <div class="swiper-slide">
                                                    <img src="{{ asset('/../template/assets/images/item-background/bg-action-1.png') }}"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="logo-rotate">
                                <img class=""
                                    src="{{ asset('/../template/assets/images/item-background/item6-img.png') }}"
                                    alt="">
                            </div>
                            <h2>Subscribe to our newsletter</h2>
                            <p>Subscribe for our newsletter to stay in the loop</p>
                            <fieldset class="email">
                                <input type="email" class="style-1" id="email"
                                    placeholder="Email address*" name="email" tabindex="2" value=""
