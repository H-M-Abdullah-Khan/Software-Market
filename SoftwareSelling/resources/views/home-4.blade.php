...
<!-- Mirrored from themesflat.co/html/open9/home-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:17:31 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
    ...
    <div id="wrapper">
        <div id="page" class="pt-40">
                                        ...
                                        <ul id="menu-primary-menu" class="menu">
                                            <li class="menu-item menu-item-has-children current-menu-item">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="menu-item current-item"><a href="home-4.html">Home 4</a></li>
                ...
                <div class="themesflat-container w-full">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="content">
                                <h1 data-wow-delay="0s" class="wow fadeInUp">Discover, collect, <br> & sell NFTs</h1>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="banner__right relative">
                                <div class="logo-rotate">
                                    ...
                                    <img class="logotext" src="assets/images/item-background/item6-text.png" alt="">
                                </div>
                                <div class="swiper-container swiper-3d-2card" data-swiper='{
                                    "loop": false,
                                    "spaceBetween": 0,
                                    "slidesPerView": 1,
            ...
            <div class="tf-section create-sell">
                <div class="themesflat-container">
                    <div class="row pl-2-5">
                        <div class="col-md-12">
                            <div class="heading-section">
                                <h2 class="tf-title pb-30">Step by step Create and <br> Sell Your NFTs</h2>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="grid-box-icon">
                                <div data-wow-delay="0s" class="wow fadeInUp tf-box-icon style-1 relative mb-0">
                                    <div class="image">
                                ...
                                <div data-wow-delay="0.1s" class="wow fadeInUp tf-box-icon style-1 relative mb-0">
                                    <div class="image">
                                ...
                                <div data-wow-delay="0.2s" class="wow fadeInUp tf-box-icon style-1 relative mb-0">
                                    <div class="image">
                                ...
                                <div data-wow-delay="0.3s" class="wow fadeInUp tf-box-icon style-1 relative mb-0">
                                    <div class="image">
            ...
            <div class="tf-section top-collections home-4 relative">
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-section pb-20">
                                            ...
                                            <a href="author-2.html">
                                                <div class="media-images-collection">
                                                    ...
                                                    <div class="author-poster">
                                                        <img src="assets/images/avatar/avatar-03.png" alt="" class="w-full">
                                                    </div>
                                                </div>
                                            </a>
                                        ...
                                        <div class="tf-card-collection">
                                            <a href="author-2.html">
                                                <div class="media-images-collection">
                                                    ...
                                                    <div class="author-poster">
                                                        <img src="assets/images/avatar/avatar-02.png" alt="" class="w-full">
                                                    </div>
                                                </div>
                                            </a>
                                            <div class="card-bottom">
...
<!-- Mirrored from themesflat.co/html/open9/home-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Mar 2025 14:17:43 GMT -->
</html>